...
import app_objects.ImagesGalleryObject;
...
public class ImagesScreen extends Sprite{

    public var gallery:ImagesGalleryObject;
    ...
    private function drawScreen():void
    {
        ...
        vdo_bg.createObject("Resources/product_configuration/images/video_background/");
        this.addChild(vdo_bg);

        gallery = new ImagesGalleryObject();
...
//			intervalID = setTimeout(playAnimationIn, 50);
    ...
    private function playAnimationIn():void{
        ...
        TweenMax.to(gallery, 0.5, {y:300, alpha:1, ease:Cubic.easeOut, delay:0.5});
        TweenMax.to(exit_button, 0.4, {scaleX:1, scaleY:1, ease:Back.easeOut, delay:1});
