...
//	import starling.core.Starling;
	...
	public class imagesButtonObject extends Sprite
	{
		...
		public function imagesButtonObject()
		{
			//super();
		...
		public function createObject(assets:AssetManager, btnType:String):void
		{
			...
			button_normal = new Image(sAssets.getTexture("images_icon_normal"));
			button_normal.pivotX = button_normal.width/2;
			button_normal.pivotY = button_normal.height/2;
			this.addChild(button_normal);

			button_activated = new Image(sAssets.getTexture("images_icon_activated"));
			...
			button_text_normal = new Image(sAssets.getTexture("images_icon_text"));
			...
			button_text_activated = new Image(sAssets.getTexture("images_icon_text_activated"));
